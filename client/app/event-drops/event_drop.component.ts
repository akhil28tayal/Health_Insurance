...
export class EventDropComponent implements AfterViewInit { 
	@ViewChild('timeline') timeline: ElementRef ;
	private timelines;
	private eventsMinDistance = 60;
	ngAfterViewInit(){
	...
	setDatePosition(timelineComponents, min) {
		for (var i = 0; i < timelineComponents['timelineDates'].length; i++) { 
		    var distance = this.daydiff(timelineComponents['timelineDates'][0], timelineComponents['timelineDates'][i]),
